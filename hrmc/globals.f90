...
MODULE RMC_Global
  ...
  integer, parameter ::  RMC_STEPS = 10000       ! # of rmc steps between model / sim data dumps
  integer, parameter ::  RECALC_STEPS = 1000000  ! # of accepted rmc steps between reset / original
                                                 ! calculation of simulated data
  integer :: myid, numprocs, mpierr	       ! mpi variables	
 		
END MODULE RMC_Global
