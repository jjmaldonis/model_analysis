...
contains
    ...
    subroutine read_model(param_filename, comment, m, nat, istat)
...
!call sleep(60)
    ...
    subroutine model_accept_move(m)
    ! Accept the move.
        use mpi
        type(model), intent(inout) :: m
    end subroutine model_accept_move


    subroutine model_reject_move(m)
    ! Reject the move.
        use mpi
        type(model), intent(inout) :: m
    end subroutine model_reject_move
